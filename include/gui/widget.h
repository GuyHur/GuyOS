#ifndef __GUYOS__GUI__WIDGET_H
#define __GUYOS__GUI__WIDGET_H
...
namespace guyos
{
    namespace gui
    {
        ...
        class Widget : public guyos::drivers::KeyboardEventHandler
        {
        protected:
            Widget* parent;
            common::int32_t x;
        ...
        public:
            ...
            virtual void Draw(common::GraphicsCon* gc);
